...
### [18_ring_oscillator_phase_xor.json](18_ring_oscillator_phase_xor.json)

**Схема:** Кольцевой автогенератор и фазовый XOR-детектор

**Элементы:** Battery, Resistor, Capacitor, Diode, LED, MOSFET, Switch, Voltmeter, Ground
...
**Примечание:** Автозапуск обеспечивается небольшой асимметрией каскадов: пороги MOSFET и емкости каскадов сделаны разными, чтобы схема не зависала в симметричном метастабильном состоянии.
